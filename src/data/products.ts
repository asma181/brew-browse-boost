...
const M: Mini[] = [
  ...
  { id: "espresso", category: "caffeine", name: { en: "Espresso", fr: "Espresso", ar: "إسبريسو" },
    desc: "Shot court, intense et corsé.", price: 3.000, image: U("1510707577719-ae7c14805e3a"),
    tastes: ["coffee", "budget", "traditional", "popular"], trending: true,
    pairs: ["croissant", "tiramisu"],
    ingredients: "Café 100% arabica", allergens: [],
    rating: 4.8, reviews: 180, story: "Le shot signature — court, intense, parfait." },
  { id: "americano", category: "caffeine", name: { en: "Americano", fr: "Americano", ar: "أمريكانو" },
    desc: "Espresso allongé à l'eau chaude.", price: 3.200, image: U("1497515114629-f71d768fd07c"),
    tastes: ["coffee", "budget"], pairs: ["cheesecake", "cake-caramel"],
    ingredients: "Café arabica, eau chaude", allergens: [],
    rating: 4.6, reviews: 95, story: "Léger en bouche, parfait pour les longues lectures." },
  { id: "cappucin", category: "caffeine", name: { en: "Cappucin", fr: "Cappucin", ar: "كابوسين" },
    desc: "Petit cappuccino — mousse de lait.", price: 3.300, image: U("1572442388796-11668a67e53d"),
    tastes: ["coffee", "budget"], pairs: ["tiramisu", "croissant"],
    ingredients: "Café, lait, mousse de lait",
    allergens: ["milk"], rating: 4.5, reviews: 60, story: "Format mini, plaisir maxi." },
  { id: "cafe-latte", category: "caffeine", name: { en: "Café Latte", fr: "Café Latté", ar: "كافيه لاتيه" },
    desc: "Café lait doux et velouté.", price: 3.500, image: U("1461023058943-07fcbe16d735"),
    tastes: ["coffee", "popular"], pairs: ["pancake", "crepe-sucree"],
    ingredients: "Café, lait chaud, mousse de lait", allergens: ["milk"],
    rating: 4.7, reviews: 130, story: "Onctueux, équilibré — l'éveil tout en douceur." },
  { id: "nescafe", category: "caffeine", name: { en: "Nescafé", fr: "Nescafé", ar: "نسكافيه" },
    desc: "Café soluble crémeux.", price: 3.500, image: U("1495474472287-4d71bcdd2085"),
    tastes: ["coffee", "budget"], pairs: ["cake", "croissant"],
    ingredients: "Café soluble, lait, sucre",
    allergens: ["milk"], rating: 4.3, reviews: 40, story: "Le café réconfort à toute heure." },
  { id: "chocolat-lait", category: "caffeine", name: { en: "Hot Chocolate Milk", fr: "Chocolat au Lait", ar: "شوكولاتة بالحليب" },
    desc: "Lait chaud au cacao.", price: 3.500, image: U("1517578239113-b03992dcdd25"),
    tastes: ["sweet", "budget"], pairs: ["fondant-chocolat", "cake-nutella"],
    ingredients: "Lait, cacao, sucre",
    allergens: ["milk"], rating: 4.5, reviews: 55, story: "Doux et réconfortant." },
  { id: "cappuccino", category: "caffeine", name: { en: "Cappuccino", fr: "Cappuccino", ar: "كابتشينو" },
    desc: "Cappuccino classique italien.", price: 6.500, image: U("1572442388796-11668a67e53d"),
    tastes: ["coffee", "popular"], trending: true, pairs: ["tiramisu", "croissant"],
    ingredients: "Café, lait, mousse de lait", allergens: ["milk"],
    rating: 4.8, reviews: 200, story: "Mousse onctueuse, équilibre parfait." },
  { id: "chocolat-chaud", category: "caffeine", name: { en: "Hot Chocolate", fr: "Chocolat Chaud", ar: "شوكولاتة ساخنة" },
    desc: "Chocolat chaud crémeux. (+0.500 supp).", price: 6.500, image: U("1517578239113-b03992dcdd25"),
    tastes: ["sweet", "popular"], pairs: ["pancake", "tiramisu"],
    ingredients: "Chocolat noir, lait, sucre", allergens: ["milk"],
    rating: 4.8, reviews: 150, story: "Riche, fondant — comme dans les contes d'hiver." },
  { id: "cafe-turc", category: "caffeine", name: { en: "Turkish Coffee", fr: "Café Turc", ar: "قهوة تركية" },
    desc: "Café turc + sucreries traditionnelles.", price: 5.500, image: U("1509042239860-f550ce710b93"),
    tastes: ["coffee", "traditional", "popular"], pairs: ["croissant", "icecream-2"],
    ingredients: "Café turc, cardamome, sucreries traditionnelles", allergens: ["nuts"],
    rating: 4.7, reviews: 88, story: "Servi à la turque avec une touche sucrée locale." },

  // ─── Caffeine Addict — Iced Coffee ───
  { id: "americano-glace", category: "caffeine", name: { en: "Iced Americano", fr: "Americano Glacé", ar: "أمريكانو مثلج" },
    desc: "Americano sur glace (+sirop 5.500).", price: 4.500, image: U("1517701604599-bb29b565090c"),
    tastes: ["coffee", "budget"], pairs: ["cheesecake", "fondant-chocolat"],
    ingredients: "Café, eau, glaçons", allergens: [],
    rating: 4.6, reviews: 70, story: "Rafraîchissant et net — l'été dans une tasse." },
  { id: "cafe-affogato", category: "caffeine", name: { en: "Affogato", fr: "Café Affogato", ar: "كافيه أفوغاتو" },
    desc: "Boule de glace, café, noisette.", price: 6.500, image: U("1561047029-3000c68339ca"),
    tastes: ["coffee", "sweet", "popular"], pairs: ["tiramisu", "icecream-3"],
    ingredients: "Glace vanille, espresso, sirop noisette", allergens: ["milk", "nuts"],
    rating: 4.8, reviews: 95, story: "Glace fondante noyée sous un espresso brûlant." },
  { id: "ice-cream-latte", category: "caffeine", name: { en: "Ice Cream Latte", fr: "Ice Cream Latte", ar: "لاتيه آيس كريم" },
    desc: "Glaçon, lait, café, boule de glace.", price: 7.000, image: U("1517701604599-bb29b565090c"),
    tastes: ["coffee", "sweet"], pairs: ["cake-nutella", "pancake"],
    ingredients: "Lait, café, glace, glaçons", allergens: ["milk"],
    rating: 4.7, reviews: 65, story: "Crémeux et frais — l'indulgence glacée." },
  { id: "dolce-milk", category: "caffeine", name: { en: "Dolce Milk", fr: "Dolce Milk", ar: "دولتشي ميلك" },
    desc: "Glaçon, lait concentré, café, sirop.", price: 6.500, image: U("1517701604599-bb29b565090c"),
    tastes: ["coffee", "sweet"], pairs: ["cheesecake", "crepe-sucree"],
    ingredients: "Lait concentré, café, sirop, glaçons",
    allergens: ["milk"], rating: 4.7, reviews: 58, story: "Doux et caramélisé, façon dolce vita." },
  { id: "ice-latte", category: "caffeine", name: { en: "Ice Latte", fr: "Ice Latté", ar: "آيس لاتيه" },
    desc: "Glaçon, heavy cream, lait, sirop, café.", price: 6.500, image: U("1517701604599-bb29b565090c"),
    tastes: ["coffee", "popular"], pairs: ["croissant", "tiramisu"],
    ingredients: "Crème, lait, café, sirop, glaçons", allergens: ["milk"],
    rating: 4.7, reviews: 80, story: "Onctueux, frais et signature." },
  { id: "frappuccino", category: "caffeine", name: { en: "Frappuccino", fr: "Frappuccino", ar: "فرابتشينو" },
    desc: "Sirop au choix, base café, glaçon, lait.", price: 8.500, image: U("1461023058943-07fcbe16d735"),
    tastes: ["coffee", "sweet", "popular"], trending: true, pairs: ["cake-nutella", "shell"],
    ingredients: "Café, lait, glaçons, sirop au choix", allergens: ["milk"],
    rating: 4.8, reviews: 140, story: "Mixé, glacé et gourmand — la pause star." },
  { id: "chocolat-glace", category: "caffeine", name: { en: "Iced Chocolate", fr: "Chocolat Glacé", ar: "شوكولاتة مثلجة" },
    desc: "Chocolat froid crémeux.", price: 6.500, image: U("1517701604599-bb29b565090c"),
    tastes: ["sweet"], pairs: ["fondant-chocolat", "red-berry"],
    ingredients: "Cacao, lait, glaçons, sucre",
    allergens: ["milk"], rating: 4.6, reviews: 60, story: "Fraîcheur chocolatée pour les après-midi chauds." },
